	...
	void setup() {
		userRepository.findByUsername("admin").ifPresentOrElse(
				user -> {
					/* Já existe */ },
				() -> {
					com.example.authserver.model.User admin = new com.example.authserver.model.User(null, "admin",
		...
		userRepository.findByUsername("user").ifPresentOrElse(
				user -> {
					/* Já existe */ },
				() -> {
					com.example.authserver.model.User regularUser = new com.example.authserver.model.User(null, "user",
